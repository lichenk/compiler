module Compile.Types.TAST where -- Elaborated Abstract Syntax Tree
...
data CType = CInt
           ...
           | CArray CType
           | CStruct Ident
           | CNullType -- Reserved for NULL
           | CEight -- Reserved for 8 byte register types like rsp
           | CByte -- Reserved for 1 byte registers
